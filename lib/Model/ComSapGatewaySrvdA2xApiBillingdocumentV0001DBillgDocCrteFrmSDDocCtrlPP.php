...
/**
 * ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocCtrlPP Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BillingDocumentODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocCtrlPP implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_billingdocument.v0001.D_BillgDocCrteFrmSDDocCtrlPP';
    ...
    */
    ...
    public function setDefaultBillingDocumentType($default_billing_document_type)
    {
        ...
        if ((mb_strlen($default_billing_document_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $default_billing_document_type when calling ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocCtrlPP., must be smaller than or equal to 4.');
        }
