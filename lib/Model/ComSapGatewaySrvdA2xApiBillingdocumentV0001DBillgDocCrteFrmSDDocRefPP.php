...
/**
 * ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocRefPP Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BillingDocumentODV4
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocRefPP implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_billingdocument.v0001.D_BillgDocCrteFrmSDDocRefPP';
    ...
    */
    ...
    public function setSdDocument($sd_document)
    {
        ...
        if ((mb_strlen($sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sd_document when calling ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocRefPP., must be smaller than or equal to 10.');
        }
    ...
    public function setBillingDocumentType($billing_document_type)
    {
        ...
        if ((mb_strlen($billing_document_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $billing_document_type when calling ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocRefPP., must be smaller than or equal to 4.');
        }
    ...
    public function setDestinationCountry($destination_country)
    {
        ...
        if ((mb_strlen($destination_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $destination_country when calling ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocRefPP., must be smaller than or equal to 3.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if ((mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocRefPP., must be smaller than or equal to 4.');
        }
    ...
    public function setSdDocumentCategory($sd_document_category)
    {
        ...
        if ((mb_strlen($sd_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_category when calling ComSapGatewaySrvdA2xApiBillingdocumentV0001DBillgDocCrteFrmSDDocRefPP., must be smaller than or equal to 4.');
        }
